import { Box, Img, Text, Button, Link } from '@chakra-ui/react';
import React from 'react';

const Paleta = ({ src, text, subText }) => {
  // Elimina el \n del texto para el enlace de WhatsApp
  const whatsappText = text.replace(/\n/g, " ");
  const whatsappLink = `https://wa.me/5492914709293?text=Hola%20estoy%20interesado%20en%20la%20paleta%20${encodeURIComponent(whatsappText)}`;

  return (
    <Box display="flex" flexDir="column" alignItems="center" justifyContent="center">
      <Box bg="#1b2021" p="1.5em 3em" borderRadius="3px">
        <Img w="17em" h="23em" src={src} />
