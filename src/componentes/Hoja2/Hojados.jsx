...
const Hoja2 = () => {
    return(
        <Box as='section' bg="#1b2021" display="flex" alignItems="center" w="100%"  justifyContent="center" gap="9em" id='Horarios' paddingBottom={["4em","0","4em","0"]} paddingTop={["4em","0","4em","0"]}>
            ...
            <Text as="span"   >
            <Box as="div" bg="#30343f" display="flex"  justifyContent="center" h="25em" padding="3em 2em" w={["15em","20em","20em","20em"]} fontSize="2xl">
            ...
            <Img display={["none", "none","none","block"]} w="50%" h="50em" src={bahia}/>
