...
const Zapatilla = ({ src, text, subText }) => {
  ...
  const whatsappLink = `https://wa.me/5492914709293?text=Hola%20estoy%20interesado%20en%20las%20zapatilla%20${encodeURIComponent(whatsappText)}`;

  return (
    <Box display="flex" flexDir="column" alignItems="center" justifyContent="center" >
      <Box bg="#30343f" p="1.5em 3em" borderRadius="3px">
